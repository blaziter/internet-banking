...
Database::Database() try
    ...
    if (!sqlcppDb.tableExists("account") && !sqlcppDb.tableExists("card") &&
        ...
        sqlcppDb.exec(
            "CREATE TRIGGER IF NOT EXISTS update_account_updated_at BEFORE "
        ...
        sqlcppDb.exec(
            "CREATE TRIGGER IF NOT EXISTS update_card_updated_at BEFORE "
            "UPDATE OF updated_at ON card FOR EACH ROW BEGIN UPDATE card SET "
        ...
        sqlcppDb.exec(
            "CREATE TRIGGER IF NOT EXISTS update_transaction_updated_at BEFORE "
        ...
        sqlcppDb.exec(
            "CREATE TRIGGER IF NOT EXISTS update_user_updated_at BEFORE "
            "UPDATE OF updated_at ON user FOR EACH ROW BEGIN UPDATE user SET "
